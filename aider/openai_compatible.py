...
class OpenAICompatibleModelManager:
    ...
    def __init__(self) -> None:
        ...
        self._models_cache: Dict[str, tuple[List[str], float]] = {}  # url -> (models, timestamp)
    ...
    def _fetch_models(self, api_base: str) -> List[str]:
        ...
        try:
            ...
            # Silently fail - the user might not have connectivity or the endpoint might not be valid
            pass
